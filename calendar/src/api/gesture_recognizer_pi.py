...
TIME_TO_RECLASSIFY = 20
TIME_TO_COMPLETE_GESTURE = 20
...
class MediapipeHandModule():
    ...
    def main(self, send_to_server = False):
        ...
        picam2 = Picamera2()
        picam2.configure(picam2.create_preview_configuration(main={"format": 'XBGR8888', "size": (320, 240)}))
        picam2.start()
        ...
        # The landmarker is initialized. Use it here.
            while True: 
                ...
                if(self.results != None and len(self.results.handedness) > 0):
